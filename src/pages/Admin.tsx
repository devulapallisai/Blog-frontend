    ...
    <div className="mt-14 md:mt-0">
      ...
      <div className="max-w-screen-md mx-auto p-2">
        ...
        <h3 className="text-center p-4 text-3xl sm:text-4xl leading-normal font-extrabold tracking-tight text-gray-900">
          Add <span className="text-indigo-600">Admin</span>
        </h3>
        <form className="flex w-full justify-center">
          <div className="flex items-center border-b border-teal-500 py-2">
            <input
              className="sm:w-[400px] w-[270px] appearance-none bg-transparent border-none text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none"
              type="text"
